...
#ifndef AR_POSE_AR_MULTI_OUTLIER_DETECTION_H
#define AR_POSE_AR_MULTI_OUTLIER_DETECTION_H
...
namespace ar_pose
{
  ...
  private:
    ...
    void getStaticTranformations();

    ros::NodeHandle n_;
    
    tf::TransformBroadcaster broadcaster_;
    tf::TransformListener listener_transform_world_marker;
    tf::TransformListener listener_transform_base_camera;
    tf::TransformListener listener_transform_tags_camera;
    
    std::vector<tf::StampedTransform> transform_world_markers;
    ...
    double outlier_detection_max_err_to_be_inlier_;
    ar_pose::ARMarkers arPoseMarkers_;
    std::vector<geometry_msgs::Pose> arPoseVector_;
